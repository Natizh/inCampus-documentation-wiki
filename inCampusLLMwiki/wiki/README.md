...
## Read The Documentation In The App

- [Open README in the wiki](http://localhost:5211/wiki/README) (local app link): Opens this README as part of the navigable inCampus wiki interface, with search, cards, tags, and project context.
- [Open README in the markdown viewer](http://localhost:5211/document-viewer?path=README.md) (local app link): Opens the same README in the dedicated markdown/document viewer outside the immutable raw archive, useful for reading the source document in a cleaner documentation-style layout.

![inCampus wiki opening page](docs/assets/wiki-opening-page.png)

_The inCampus wiki opening page in the local viewer._
...
```md
[Original source](/raw/affine/03-05-2026/updates/Databases.md)
```
