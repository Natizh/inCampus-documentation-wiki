...
Goal: Create a new campus activity by defining category, details, location, participant limit, and participation mode so other students on the same campus can discover and join it.
