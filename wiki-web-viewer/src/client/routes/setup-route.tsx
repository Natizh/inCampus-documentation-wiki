...
interface SetupStatus {
  ...
  wikiRootSource: "env" | "saved" | "default" | "none";
...
export function Component() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <div
        aria-hidden
        className="absolute inset-0 bg-[linear-gradient(180deg,_rgba(125,152,133,0.14),_transparent_32%),repeating-linear-gradient(90deg,_transparent_0,_transparent_47px,_rgba(235,241,234,0.025)_47px,_rgba(235,241,234,0.025)_48px)]"
      />
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        {setupStatus.hasEnvOverride && (
          <div className="rounded-lg bg-[var(--teal-soft)] px-4 py-3 text-sm text-[var(--foreground)]">
        ...
        {setupStatus.configError && (
          <div className="rounded-lg bg-[var(--peach-soft)] px-4 py-3 text-sm text-[var(--foreground)]">
        ...
        <div className="space-y-3">
          <label className="block">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="surface min-w-0 flex-1 rounded-lg px-4 py-2.5 text-[0.9rem] text-[var(--foreground)] outline-none placeholder:text-[var(--muted-foreground)]"
                spellCheck={false}
                autoCapitalize="off"
                autoCorrect="off"
              />
              {setupStatus.folderPickerAvailable && (
                <button
                  ...
                  className="surface shrink-0 rounded-lg px-3 py-2.5 text-sm font-medium text-[var(--foreground)] transition-[transform,opacity] duration-150 hover:opacity-80 active:scale-[0.97] disabled:cursor-wait disabled:opacity-60"
                >
          ...
          <button
            ...
            className="w-full rounded-lg bg-[var(--primary)] px-5 py-2.5 text-sm font-semibold text-[var(--primary-foreground)] transition-[transform,opacity] duration-150 hover:opacity-90 active:scale-[0.98] disabled:cursor-wait disabled:opacity-60"
          >
            {primaryActionLabel}
          </button>

          {error && (
            <p className="rounded-lg bg-[var(--peach-soft)] px-4 py-3 text-sm text-[var(--foreground)]">
              {error}
            </p>
          )}
        </div>
